...
zen-share-overlay-add-space = Add Space to EgraTor
zen-share-overlay-add-folder = Add Folder to EgraTor
...
zen-share-confirm-description = EgraTor uploads a copy of these tabs to the share server and copies a link anyone can open. The link expires after 30 days.
