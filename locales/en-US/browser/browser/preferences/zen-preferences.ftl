...
zen-pinned-tab-manager-container-specific-essentials-enabled =
    .label = Enable container-specific favourites
...
zen-theme-marketplace-header = EgraTor Mods
...
pane-zen-marketplace-title = EgraTor Mods
...
zen-urlbar-title = EgraTor URL Bar
...
zenCKSOption-group-zen-other = Other EgraTor Features
